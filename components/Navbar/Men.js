        ...
        <div className="bg-white" onMouseEnter={(e) => {setHover("Men")}} onMouseLeave={(e) => {setHover('')}} >
            <div className="flex flex-row justify-around text-black border px-28">
                <div className=" w-1/5 py-6 flex flex-col text-start ">
                    ...
                    <button className="hover:underline text-start text-sm font-semibold text-red-500 cursor-pointer">Sale</button>
                    <button className="hover:underline text-start text-sm font-semibold cursor-pointer">Last Chance</button>
                ...
                <div className=" w-1/5 border-l py-6 pl-3 flex flex-col text-start">
                    ...
                    <div className="h-6"></div>
                    <button className=" font-bold text-start cursor-pointer mt-auto bottom-0 text-sm ">All Men&apos;s shoes</button>
                </div>
                <div className=" w-1/5 py-6 flex flex-col text-start ">
                    ...
                    <div className="h-6"></div>
                    <button className=" font-bold text-start cursor-pointer mt-auto bottom-0 text-sm ">All Men&apos;s clothing</button>
                </div>
                <div className=" w-1/5 py-6 flex flex-col text-start ">
                    ...
                    <div className="h-6"></div>
                    <button className=" font-bold text-start cursor-pointer mt-auto bottom-0 text-sm ">All Men&apos;s accessories</button>
                </div>
                <div className=" w-1/5 py-6 flex flex-col text-start ">
                    ...
                    <div className="h-6"></div>
                    <button className=" font-bold text-start cursor-pointer mt-auto bottom-0 text-sm ">All Men&apos;s sports</button>
                </div>
            </div>
        </div>
    );
